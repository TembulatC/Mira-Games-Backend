...
Backend-система для сбора и анализа данных о релизах игр на следующий месяц из Steam. Проект демонстрирует полный цикл разработки - от парсинга данных до аналитики.
...
## Внимание!
Перед запуском контейнера сделайте еще одну копию `.env.Example` и переименуйте эту копию в `.env`
```
